    ...
    , configuration_(descriptor)
{
    ...
    {
        interface_whitelist_.emplace_back(ip::address_v4::from_string(interfaceName));
    }
...
bool TCPv4Transport::is_interface_allowed(const std::string& interfaceName) const
{
    return is_interface_allowed(asio::ip::address_v4::from_string(interfaceName));
}
